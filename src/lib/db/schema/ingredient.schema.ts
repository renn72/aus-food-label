...
export const ingredient = sqliteTable('ingredient', {
  ...
  favouriteAt: integer('favourite_at', { mode: 'timestamp' }),
  deletedAt: integer('deleted_at', { mode: 'timestamp' }),
  hiddenAt: integer('hidden_at', { mode: 'timestamp' }),
  isAusFood: integer('is_aus_food', { mode: 'boolean' }),
  isAllStores: integer('is_all_stores', { mode: 'boolean' }).default(true),
  ...
  isSupplement: integer('is_supplement', { mode: 'boolean' }).default(false),
